 ...
 * Google Sheets, Firebase, and OAuth2.
 *
 * The {@link OAuth2} class uses the
 * <a href="https://developers.google.com/identity/gsi/web/reference/js-reference" target="_blank">Google Identity Service</a>,
...
/**
 * Provides a simple way to use Google's OAuth functionality.
 *
...
export declare class OAuth2 {
     ...
     * @deprecated since version 5.20231
     *
     * No need for signOut() on the new API
     * [Credits]{@link: https://developers.google.com/identity/oauth2/web/guides/migration-to-gis#library_quick_reference}
     *
     */
    signOut(): void;
    /**
    ...
    _initClient(_apiKey: string, clientId: string, scopes: string[]): void;
}
/**
